...
import { Breadcrumb, BreadcrumbItem, Form, FormGroup, Input, Col, Button, Label, FormFeedback } from 'reactstrap';
...
class Contact extends Component {
    ...
    handleSubmit(event){
        console.log('Currenct state is : ' + JSON.stringify(this.state));
        alert('Currenct state is : ' + JSON.stringify(this.state));
                        ...
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type='tel' id='telnum' name='telnum' placeholder='Tel. number'
                                        value={this.state.telnum} onChange={this.handleChange} 
                            ...
                            <FormGroup row>
                                <Col md={{size:10, offset:2}}>
                                    <Button type='send' color='primary'>Send Feedback</Button>
                                </Col>
                            </FormGroup>
                        </Form>
                    </div>
